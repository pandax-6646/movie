var homeView = {
          ...
          <a href="./detail.html?filmId=${value.filmId}" class="flex jc-sb">
            ...
            <div class="fg1 ml-10">
              ...
              <p class="mb-10">
                <span>观众评分</span>
                <span class="score">${
                  value.grade ? Number(value.grade).toFixed(1) : "6.0"
                }</span>
              </p>
  ...
  getPullData() {
    ...
    var containerBot =
      parseInt($Container.css("height")) + $Container.offset().top;
    ...
    window.onscroll = async function () {
      ...
      if (scrollY + H - navBottomH - containerBot >= 10 && lock) {
        ...
        await utils
          .getData("film/getList", pageNum, "get")
          .then(function (res) {
